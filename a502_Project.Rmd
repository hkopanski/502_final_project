...
Furthermore, the 95% confidence interval in the non pooled case was found to be `r CI_nonpooled[1]` to `r CI_nonpooled[2]`. It can be noted that zero is absent from this range, as in the case of the pooled sample variance. In this second scenario, there is sufficient evidence to reject the null hypothesis and to support the alternative at an $\alpha$ level of 0.05.
...
rnames <- c("template creation", "code", "code review", "write up", "editing", "formatting", "discussion", "calculation verification")
