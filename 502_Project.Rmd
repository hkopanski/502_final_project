...
# HA: mean = 5, var = 1
df_combo <- data.frame(expand.grid(mu1, var1, n1, mu2, var2, n2))
df_combo2 <- cbind(1:nrow(df_combo), df_combo, rep(0, nrow(df_combo)))
colnames(df_combo2) <- c("Test Case", "mu1", "var1", "n1", "mu2", "var2", "n2", "Test Results")
